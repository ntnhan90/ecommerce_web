import { faAddressCard, faBell, faFileLines, faStar } from "@fortawesome/free-solid-svg-icons";
import { faBug, faCalculator, faChartPie, faCode, faDroplet, faGauge,
    faLayerGroup, faLocationArrow, faPencil, faPuzzlePiece, faRightToBracket
